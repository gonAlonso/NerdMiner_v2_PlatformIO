...
void runWorker(void *name)
{
  ...
  while (true)
  {
    ...
    Serial.println(sub_details);
    Serial.print("extranonce1: ");
    Serial.println(extranonce1);
    Serial.print("extranonce2_size: ");
    Serial.println(extranonce2_size);
    Serial.print("method: ");
    ...
    Serial.print("merkle_branch size: ");
    Serial.println(merkle_branch.size());
    ...
    Serial.print("clean_jobs: ");
    Serial.println(clean_jobs);
    line = client.readStringUntil('\n');
    deserializeJson(doc, line);
    line = client.readStringUntil('\n');
    deserializeJson(doc, line);
